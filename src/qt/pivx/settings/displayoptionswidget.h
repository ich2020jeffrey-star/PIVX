...
#ifndef PIVX_QT_PIVX_SETTINGS_DISPLAYOPTIONSWIDGET_H
#define PIVX_QT_PIVX_SETTINGS_DISPLAYOPTIONSWIDGET_H
...
#endif // PIVX_QT_PIVX_SETTINGS_DISPLAYOPTIONSWIDGET_H
